...
public class MapperConfiguration {
    ...
    public ModelMapper userMapper(){
        ...
        //configuro conversion DTO a entidad
        ...
        TypeMap<User, UserDto> typeMapEntity2Dto =
        ...
        TypeMap<PhoneDto, Phone> typeMapPhoneDto2Entity =
                modelMapper.createTypeMap(PhoneDto.class, Phone.class);
